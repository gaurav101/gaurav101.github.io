(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{label:`Features`,href:`#features`},{label:`Playground`,href:`#playground`},{label:`Use Cases`,href:`#use-cases`},{label:`API`,href:`#api`},{label:`Demos`,href:`#demos`},{label:`Install`,href:`#install`},{label:`Docs`,href:`./docs`},{label:`Storybook`,href:`./examples/react/storybook`},{label:`GitHub`,href:`https://github.com/gaurav101/LuminaJS/`}],t={github:`https://github.com/gaurav101/LuminaJS/`},n={label:`LuminaJS 2.1`,text:`Canvas filters, React components, crop workflows, and CSS image utilities in one browser-first package.`,href:`https://gaurav101.github.io/LuminaJS/docs`},r={eyebrow:`The browser image engine for modern JavaScript apps`,title:`Edit, transform, and export images where your users already are.`,body:`LuminaJS is a developer-friendly image processing toolkit for product teams building upload flows, profile editors, creative tools, CMS dashboards, and media-heavy web apps without sending every pixel through a backend job.`,actions:[{label:`Launch React Demo`,href:`./examples/react`,variant:`primary`},{label:`JS Demo`,href:`https://gaurav101.github.io/LuminaJS/vanilla-js`,variant:`secondary`,icon:`code`},{label:`CSS Demo`,href:`https://gaurav101.github.io/LuminaJS/css-demo`,variant:`accent`,icon:`brush`},{label:`Explore API Docs`,href:`https://gaurav101.github.io/LuminaJS/docs`,variant:`secondary`},{label:`View GitHub`,href:`https://github.com/gaurav101/LuminaJS/`,variant:`accent`,icon:`github`}],badges:[{value:`0 runtime deps`,label:`Canvas-native core`,icon:`gauge`},{value:`Only 3.8 kB gzipped`,label:`Minified browser bundle`,icon:`download`}],metrics:[{value:`4 output types`,label:`Canvas, Blob, data URL, and ImageData export paths.`,icon:`download`},{value:`3 ways to use`,label:`Core JavaScript, React components, and CSS utilities.`,icon:`layers`}]},i=[{id:`vanilla`,label:`Vanilla JS`,icon:`code`,code:`import { lumina } from '@gks101/luminajs';
...
}`}],d=[{label:`React`,title:`Image editor demo`,body:`Live filters, resize, crop, watermark, ASCII, hooks, and components.`,href:`https://gaurav101.github.io/LuminaJS/examples/react`,icon:`react`},{label:`JavaScript`,title:`Vanilla browser demo`,body:`Drag-and-drop processing with Canvas exports and transform controls.`,href:`https://gaurav101.github.io/LuminaJS/vanilla-js`,icon:`code`},{label:`CSS`,title:`Lumina Image CSS`,body:`Utility classes for responsive image styling and hover effects.`,href:`https://gaurav101.github.io/LuminaJS/css-demo`,icon:`brush`},{label:`Reference`,title:`Generated docs`,body:`API reference generated from source comments.`,href:`https://gaurav101.github.io/LuminaJS/docs`,icon:`book`},{label:`Storybook`,title:`React stories`,body:`Component examples for React integration and documentation.`,href:`https://gaurav101.github.io/LuminaJS/examples/react/storybook`,icon:`boxes`}],f={eyebrow:`React application demo`,title:`See LuminaJS running inside the React image editor.`,body:`The React demo shows the library in a real application flow: upload an image, tune visual filters, resize and crop, preview the result, and export from the browser without a backend processing step.`,video:`./react-demo.mp4`,href:`https://gaurav101.github.io/LuminaJS/examples/react`},p=[{label:`Core API`,title:`Compose image operations fluently.`,body:`Use the chain API for direct JavaScript workflows and framework-agnostic tools.`,code:`import { lumina } from '@gks101/luminajs';
